...
public class DataLoader {
    ...
    CommandLineRunner seed(
        ...
        return args -> {
            ...
            // Vídeos (inclui alguns "Missão" no título)
            ...
            // Visualizações e Avaliações aleatórias
            ...
            for (var v : vids) {
                ...
                for (int i = 0; i < plays; i++) {
                    ...
                    visualizacaoRepo.save(Visualizacao.builder()
                            .usuario(user)
                            .video(v)
                            .instante(Instant.now().minusSeconds(rnd.nextInt(60*60*24*30)))
                            .build());
                }
                int ratings = 5 + rnd.nextInt(20);
                for (int i = 0; i < ratings; i++) {
                    var user = (i % 2 == 0) ? alice : bob;
                    double nota = 2.5 + rnd.nextDouble() * 2.5; // 2.5 a 5.0
            ...
            // Demonstrações das consultas solicitadas (log no console)
